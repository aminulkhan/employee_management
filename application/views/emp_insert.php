...
#footer { 
    ...
    <form action='http://localhost/codeigniter/index.php/user/emp_insert' method='POST' accept-charset='UTF-8' class="form">
        <fieldset>
            	<h1><span></span> EMP Registration Form</h1>
